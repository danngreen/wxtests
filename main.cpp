...
void BasicGLPane::mouseReleased(wxMouseEvent& event) {	rot += 10;
}
void BasicGLPane::rightClick(wxMouseEvent& event) {}
void BasicGLPane::mouseLeftWindow(wxMouseEvent& event) {	rot += 10;
}
void BasicGLPane::keyPressed(wxKeyEvent& event) {	rot += 10;
}
...
BasicGLPane::BasicGLPane(wxFrame* parent, int* args) :
    wxGLCanvas(parent, wxID_ANY, args, wxDefaultPosition, wxDefaultSize, wxFULL_REPAINT_ON_RESIZE), rot(45.0)
{
...
void BasicGLPane::prepare3DViewport(int topleft_x, int topleft_y, int bottomrigth_x, int bottomrigth_y)
{
    ...
    glClearColor(0.0f, 0.0f, rot/360.0f, 1.0f); // Black Background
    ...
    gluPerspective(rot /*view angle*/, ratio_w_h, 0.1 /*clip close*/, 200 /*clip far*/);
